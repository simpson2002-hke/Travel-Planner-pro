...
const en = {
  ...
  addOptionalPlace: "Add Optional Place", editOptionalPlace: "Edit Optional Place", saveOptionalPlace: "Save Optional Place", moveToSchedule: "Move to Schedule", moveToOptional: "Move to Optional",
...
const zh: typeof en = {
  ...
  addOptionalPlace: "新增備選地點", editOptionalPlace: "編輯備選地點", saveOptionalPlace: "儲存備選地點", moveToSchedule: "加入已排定行程", moveToOptional: "移到備選地點",
