...
const en = {
  ...
  swapWith: "Swap with",
  swapDayButton: "Swap {dayA} ↔ {dayB}",
  swapItineraryHelp: "You are viewing {day}. Choose another date to switch all activities.",
  splitTimelineByTraveler: "Split timeline by traveler",
  noTravelerActivities: "No activities for this traveler on {day}.",
...
const zh: typeof en = {
  ...
  swapWith: "與哪一天互換",
  swapDayButton: "互換 {dayA} ↔ {dayB}",
  swapItineraryHelp: "你目前在查看 {day}。選擇另一日期可互換全部活動。",
  splitTimelineByTraveler: "按旅客分開顯示行程",
  noTravelerActivities: "此旅客在 {day} 沒有活動。",
  splitMode: "分攤模式",
